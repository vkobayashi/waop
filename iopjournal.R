...
setwd("C:/Users/VBKobayashi/Documents/publications/waop_submission/iops")
...
myfunctionparser<-function(year,volume){
	...
	for(i in 1:length(year)){
		for(j in 1:3){
			webpage<-append(webpage,paste("http://onlinelibrary.wiley.com/doi/10.1111/iops.", year[i], ".", volume[i],".", "issue-",j,"/issuetoc", sep=""))
		}
	}

	regname<-"iops\\.[[:digit:]]{4}\\.[[:digit:]]+\\.issue\\-[1-4]"
